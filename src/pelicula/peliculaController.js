...
const peliculaCollection = client.db('cine-db').collection('peliculas-iplacex');
...
// Controlador para obtener una película por _id
...
// Controlador para actualizar una película por _id
...
// Controlador para eliminar una película por _id
